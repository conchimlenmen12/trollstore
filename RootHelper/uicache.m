...
bool registerPath(NSString *path, BOOL unregister, BOOL forceSystem) {
	...
	if (appBundleID && !unregister) {
		...
		dictToRegister[@"IsDeletable"] = @(![appBundleID isEqualToString:@"com.viptroll.CheatiOSVipStore"] && kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_15_0);
